...
TITLE = "Hiển thị dữ liệu trade và biểu đồ box plot (Box Plot)"
...
st.subheader("Biểu đồ box plot (Box Plot) từ trade_data")
fig = px.box(df, x="side", y="price", title="Phân phối giá (Box Plot)")
