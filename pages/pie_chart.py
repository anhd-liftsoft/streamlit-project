...
TITLE = "Hiển thị dữ liệu trade và biểu đồ bánh (Pie Chart)"
...
# Biểu đồ pie chart
st.subheader("Biểu đồ pie (Pie Chart) từ trade_data")
fig = px.pie(
    df,
    names='is_buyer_maker',
    title='Tỷ lệ Is Buyer Maker',
    labels={'is_buyer_maker': 'Is Buyer Maker', 'count': 'Count'}
)
