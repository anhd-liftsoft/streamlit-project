...
TITLE = "Hiển thị dữ liệu trade và biểu đồ phân tán (Scatter Plot)"
...
st.subheader("Biểu đồ scatter (Scatter Plot) từ trade_data")
fig = px.scatter(
    df,
    x='price',
    y='quote_qty',
    title='Scatter Plot của Price và Quantity',
    labels={'price': 'Price', 'quote_qty': 'Quote Quantity'},
    opacity=0.6
)
